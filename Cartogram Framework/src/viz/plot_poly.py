...
# def plot_polys_data(data, title="Polygons", plot_points=False, centroids=False, label_vertices=False, legend=True, target_centers=None, names=None, svg=False, new=True):
...
def plot_polys_data(data, title="Polygons", plot_original_outlines=False, plot_points=False, centroids=False, label_vertices=False, legend=True, target_centers=None, names=None, svg=False, new=True):
    ...
    for idx, name in enumerate(data):
        ...
        plt.plot(original_poly[:,0], original_poly[:,1], color='gray', linestyle='--', alpha=0.5, label=f"Original {name}") if plot_original_outlines else None
