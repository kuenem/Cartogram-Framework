...
def CartogramFramework_global(
    ...
    #  This runs BEFORE the data dict is populated below, so every record
    #  reflects the final, fully-post-processed geometry rather than an
    #  intermediate state.
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 11. Populate the data dict — single source of truth for results.
