...
Unified cartogram optimisation covering:
  ...
  - Original-shape (contiguous-precursor) deformation
...
from contiguous_cartogram_2 import contiguous_cartogram, build_shared_vertex_constraints
...
def CartogramFramework_global_CLAUDE_2(
    ...
    for k, poly in enumerate(polygons):
        ...
        elif shape in ("contiguous", "contiguous2"):
